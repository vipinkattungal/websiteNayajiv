...
const step_data: DataType[] = [
  {
    ...
    title: "Research",
    info: <>In-depth analysis to  <br /> understand your needs</>,
    duration: ".6s",
    delay: ".6s",
  },
  {
    ...
    title: "Design",
    info: <>Crafting intuitive and <br /> user-friendly solutions</>,
    duration: ".5s",
    delay: ".5s",
  },
  {
    ...
    cls: "text-center mb-30 wow bounceIn",
    title: "Development",
    info: <>Building scalable and  <br />robust applications</>,
    duration: ".4s",
    delay: ".4s",
  },
  {
    ...
    cls: "tp-step-item-even text-center mb-30 wow bounceIn",
    title: "Production",
    info: <>Delivering high-quality,  <br /> ready-to-launch solutions</>,
    duration: ".5s",
    delay: ".5s",
  },
]
